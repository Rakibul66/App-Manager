...
import com.lite.apmanager.Adapters.ApkInfoExtractor
import com.lite.apmanager.Adapters.AppsAdapter
import com.lite.apmanager.Classes.AppInfo
import com.lite.apmanager.Classes.AppManager
import com.lite.apmanager.Constants.Constants
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val spinnerArrayAdapter = ArrayAdapter.createFromResource(actvityContext as MainActivity, R.array.spinner_app_type, R.layout.support_simple_spinner_dropdown_item)
        spinner.adapter = spinnerArrayAdapter

        apkInfoExtractor = ApkInfoExtractor(this)
        recyclerViewLayoutManager =
            GridLayoutManager(actvityContext, 1)
